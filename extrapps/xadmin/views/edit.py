...
from django.contrib.gis.admin import widgets as gis_widgets
...
FORMFIELD_FOR_DBFIELD_DEFAULTS = {
    ...
    # add
    # gis_models.MultiPolygonField: {'widget': widgets.AdminOpenLayersWidget},
    gis_models.MultiPolygonField: {'widget': widgets.AdminTextareaWidget},
}
